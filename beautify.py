...
class Face(Organ):
    ...
    def __init__(self, im_bgr, img_hsv, temp_bgr, temp_hsv, landmarks, index):
        ...
        mask_organs = (
                self.organs['mouth'].get_mask_abs() + mask_nose + self.organs['left eye'].get_mask_abs() + self.organs[
                'right eye'].get_mask_abs() + self.organs['left brow'].get_mask_abs() + self.organs[
...
class Makeup():
    ...
    def __init__(self, predictor_path="D:/ComputerView/data/shape_predictor_68_face_landmarks.dat"):
        self.photo_path = []
...
if __name__ == '__main__':
    path = 'D:/ComputerView/AIMakeup-master/raw/10.jpg'
    mu = Makeup()
