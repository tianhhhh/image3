...
from beautify import Makeup, Face, Organ, NoFace
...
class Ui_MainWindow(object):
    def __init__(self, MainWindow):
        ...
        # 导入dlib模型文件
        if os.path.exists("D:/ComputerView/data/shape_predictor_68_face_landmarks.dat"):
            self.path_predictor = os.path.abspath("D:/ComputerView/data/shape_predictor_68_face_landmarks.dat")
        else:
    ...
    def retranslateUi(self):
        ...
        #self.bt_enlargeEyes.setText(_translate("MainWindow", "大眼"))
